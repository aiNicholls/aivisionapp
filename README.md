Android app using MSvision (now Azure AI). This app was designed to have surroundings and objects described to the user using text to speech, specifically to help with visually impaired users.
